...
namespace simple
{
  ...
  public:
    ...
    /** \brief Use mutual information between two images.
     *
     * \sa itk::MutualInformationImageToImageEfficientEntropyMetricv4
     */
    SITK_RETURN_SELF_TYPE_HEADER SetMetricAsMutualInformationEfficientEntropy(unsigned int numberOfHistogramBins = 20,
        double varianceForJointPDFSmoothing = 1.5);
  ...
  private:
    ...
    enum MetricType { ANTSNeighborhoodCorrelation,
                      ...
                      MutualInformationEfficientEntropy,  
                      MeanSquares,
