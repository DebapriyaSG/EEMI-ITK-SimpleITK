...
#include "itkMutualInformationImageToImageEfficientEntropyMetricv4.h"
...
int
itkMutualInformationImageToImageEfficientEntropyMetricv4Test(int, char *[])
{
  ...
  /* The metric */
  using MetricType = itk::MutualInformationImageToImageEfficientEntropyMetricv4<ImageType, ImageType, ImageType>;
  auto metric = MetricType::New();

  ITK_EXERCISE_BASIC_OBJECT_METHODS(metric, MutualInformationImageToImageEfficientEntropyMetricv4, ImageToImageMetricv4);
