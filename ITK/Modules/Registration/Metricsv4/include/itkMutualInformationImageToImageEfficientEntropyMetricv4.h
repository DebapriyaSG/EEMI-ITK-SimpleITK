...
#ifndef itkMutualInformationImageToImageEfficientEntropyMetricv4_h
#define itkMutualInformationImageToImageEfficientEntropyMetricv4_h
...
class ITK_TEMPLATE_EXPORT MutualInformationImageToImageEfficientEntropyMetricv4
  : public ImageToImageMetricv4<TFixedImage, TMovingImage, TVirtualImage, TInternalComputationValueType, TMetricTraits>
{
public:
  ITK_DISALLOW_COPY_AND_MOVE(MutualInformationImageToImageEfficientEntropyMetricv4);

  /** Standard class type aliases. */
  using Self = MutualInformationImageToImageEfficientEntropyMetricv4;
  using Superclass =
  ...
  itkTypeMacro(MutualInformationImageToImageEfficientEntropyMetricv4, ImageToImageMetricv4);
...
protected:
  ...
  ~MutualInformationImageToImageEfficientEntropyMetricv4() override = default;
...
#  include "itkMutualInformationImageToImageEfficientEntropyMetricv4.hxx"
#endif
